...
class HaClimateControl extends EventsMixin(PolymerElement) {
  static get template() {
    ...
    <div class="control-buttons">
      <div>
        <paper-icon-button disabled="[[isOffMode]]" icon="hass:chevron-up" on-click="incrementValue"></paper-icon-button>
      </div>
      <div>
        <paper-icon-button disabled="[[isOffMode]]" icon="hass:chevron-down" on-click="decrementValue"></paper-icon-button>
      </div>
    </div>
`;
  }
